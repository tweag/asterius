...
genNode LinkReport {..} m_bin =
  mconcat
    ...
    , "), {rts: {print: console.log, panic: (e => console.error([\"errGCEnter1\", \"errGCFun\", \"errBarf\", \"errStgGC\", \"errUnreachableBlock\", \"errHeapOverflow\", \"errMegaBlockGroup\"][e-1])), traceCmm: (f => console.log(\"Entering \" + fs[f-1] + \", Sp: \" + i.exports._get_Sp() + \", SpLim: \" + i.exports._get_SpLim() + \", Hp: \" + i.exports._get_Hp() + \", HpLim: \" + i.exports._get_HpLim())), traceCmmBlock: ((f, lbl) => console.log(\"Entering \" + fs[f-1] + \", basic block \" + lbl + \", Sp: \" + i.exports._get_Sp() + \", SpLim: \" + i.exports._get_SpLim() + \", Hp: \" + i.exports._get_Hp() + \", HpLim: \" + i.exports._get_HpLim())), traceCmmSetLocal: ((f,i,x) => console.log(\"In function \" + fs[f-1] + \", setting local register \" + i + \" to \" + x))}}).then(r => {i = r.instance; i.exports.main();});\n"
    ]
