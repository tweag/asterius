...
export class ByteStringCBits {
  ...
  fps_memcpy_offsets(_dst, dst_off, _src, src_off, n) {
    const dst = Memory.unTag64(_dst), src = Memory.unTag64(_src);
  ...
  _hs_bytestring_itoa(x, _buf, base, pad) {
    const buf = Memory.unTag64(_buf), x_str = x.toString(base).padStart(pad, "0");
