...
export function newAsteriusInstance(req) {
  let __asterius_logger = new EventLogManager(req.symbolTable),
    ...
    __asterius_sancheck = new SanCheck(__asterius_memory, __asterius_stableptr_manager, req.infoTables),
    __asterius_gc = new GC(__asterius_memory, __asterius_mblockalloc, __asterius_stableptr_manager);
