...
RUN \
  ...
  (curl -L https://github.com/TerrorJack/wasi-sdk/releases/download/201025/wasi-sdk-11.6g353da434653e-linux.tar.gz | tar xz -C ${WASI_SDK_PATH} --strip-components=1) && \
